...
#### API Documentation
API Documentation can be found [here](https://app.swaggerhub.com/apis-docs/kthare10/controller/1.0.0)
...
python3 -m controller.swagger_server
```

and open your browser to here:

```
http://localhost:8081/fabric/controller/ui/
```

Your Swagger definition lives here:

```
http://localhost:8081/fabric/controller/swagger.json
```
...
docker run -p 8081:8081 controller 
...
In a browser, go to [Swagger definition](https://app.swaggerhub.com/apis/kthare10/controller/1.0.0)
